...
function reverseString(s) {
    var reversed = "";
    var idx;
    s = String(s); // This will make it the string equivalent of whatever gets passed 
...
function minimum(n1, n2) {
    ...
    // return n2 < n1 ? n2 : n1;
    // if the expression before the question mark is true,then return the left else return right
};
